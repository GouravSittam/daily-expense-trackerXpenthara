...
/**
 * Shuffle component for animated text with shuffle effect
 * @param {string} text - Text to animate
 * @param {string} className - Additional CSS classes
 * @param {Object} style - Inline styles
 * @param {string} shuffleDirection - Direction of shuffle: 'left' or 'right'
 * @param {number} duration - Animation duration
 * @param {number} maxDelay - Maximum delay between animations
 * @param {string} ease - GSAP easing function
 * @param {number} threshold - Scroll trigger threshold
 * @param {string} rootMargin - Scroll trigger root margin
 * @param {string} tag - HTML tag to use
 * @param {string} textAlign - Text alignment
 * @param {Function} onShuffleComplete - Callback when shuffle completes
 * @param {number} shuffleTimes - Number of shuffle iterations
 * @param {string} animationMode - Animation mode: 'evenodd' or other
 * @param {boolean} loop - Whether to loop animation
 * @param {number} loopDelay - Delay between loop iterations
 * @param {number} stagger - Stagger delay between elements
 * @param {string} scrambleCharset - Character set for scrambling
 * @param {string} colorFrom - Starting color
 * @param {string} colorTo - Ending color
 * @param {boolean} triggerOnce - Trigger animation only once
 * @param {boolean} respectReducedMotion - Respect reduced motion preference
 * @param {boolean} triggerOnHover - Trigger animation on hover
 */
const Shuffle = ({
  text,
  className = '',
